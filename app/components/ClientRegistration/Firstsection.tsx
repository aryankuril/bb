...
const Firstsection = () => {
  ...
  <span className="text-highlight">Let’s Create something amazing.</span>
</h1>

      </div>

          {/* Station Board */}
          <div className="lg:absolute lg:top-7 top-15 lg:right-15 right-5 flex justify-end w-full lg:w-auto">
            <img
              src="/images/ONBOARDING.png"
              alt="Decorative element"
              className="w-20 sm:w-40 md:w-48 lg:w-56 xl:w-54 h-auto"
            />
          </div>
        </div>
