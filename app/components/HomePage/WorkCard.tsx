...
export default function StackingCards() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full">
      ...
      <div className="sticky top-16 md:top-20 h-[100svh] flex items-center justify-center">
                ...
                <div className="flex flex-col justify-center min-h-0">
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3 mt-4">
                    {card.tags.map((t, idx) => (
                      <span
                        key={idx}
                        className="text-xs sm:text-sm px-3 py-1 rounded-full border border-white/30/ [text-wrap:balance]"
                      >
                        {t}
                      </span>
                    ))}
                  ...
                  <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg leading-relaxed opacity-90">
                    {card.content}
                  </p>
                </div>
                ...
                <div className="w-full h-full">
                  <div className="w-full h-full rounded-xl overflow-hidden bg-white/5 border border-white/10">
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src =
                          "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 450'%3E%3Crect width='100%25' height='100%25' fill='%23151515'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' fill='%23aaaaaa' font-family='system-ui' font-size='24'%3EImage%20placeholder%3C/text%3E%3C/svg%3E";
                      }}
                    />
                  </div>
                </div>
