...
const SecondSection = () => {
 ...
 <section className="container py-12 sm:py-16 md:py-24">
  ...
  <div className="text-center mb-8 sm:mb-12">
    <h2 className="miso-font text-[#1D1D1D] text-[32px] sm:text-[50px] md:text-[80px] leading-[40px] sm:leading-[60px] md:leading-[80px] tracking-[-1px] sm:tracking-[-1.5px] md:tracking-[-2.4px] font-normal capitalize max-w-[1800px] flex-[1_0_0] mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
      ...
      <div className="col-span-1 md:col-span-3 relative h-[220px] sm:h-[300px] md:h-[400px] rounded-[20px] sm:rounded-[30px] overflow-hidden bg-gradient-to-t from-black/100 to-black/0">
        ...
        <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 flex items-end gap-2 sm:gap-4">
          <span className="miso-font text-[#FAB31E] text-[50px] sm:text-[80px] md:text-[120px] leading-[50px] sm:leading-[80px] md:leading-[120px] font-normal capitalize">
            {processSteps[0].number}
          </span>
          <h3 className="miso-font text-white text-[24px] sm:text-[36px] md:text-[50px] leading-[36px] sm:leading-[50px] md:leading-[73px] font-normal capitalize">
