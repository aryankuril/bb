...
const FirstsectionDesktop: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    // Desktop: allow full fit (never less than 1)
    setTargetScale(Math.max(1, fitScale));
  }, []);

  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: ["start 0.50", "start 0.20"],
  });

  const smooth = useSpring(scrollYProgress, { stiffness: 90, damping: 20, mass: 0.2 });
        ...
        >
          ...
          <div className="flex flex-wrap lg:gap-4 gap-1 justify-center lg:mt-20 mt-0">
            <div className="w-[32%] max-w-[562px] lg:w-[562px]">
              <Image src="/images/teams/1.png" alt="Big Image" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>

            <div className="w-[32%] max-w-[350px] lg:w-[350px]">
              <Image src="/images/teams/2.png" alt="Small 1" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>

            <div className="w-[32%] max-w-[350px] lg:w-[350px]">
              <Image src="/images/teams/3.png" alt="Small 2" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>
          </div>
          ...
          <div className="flex flex-wrap lg:gap-4 gap-1 justify-center">
            <div className="w-[32%] max-w-[350px] lg:w-[350px] lg:h-[370px] h-[200px] flex-shrink-0">
              <Image src="/images/teams/4.png" alt="Hands" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>

            {/* Animated zoom image (desktop) */}
            <motion.div
              ref={zoomRef}
            ...
            >
              <Image src="/images/teams/team5.webp" alt="Hands Zoom" fill
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </motion.div>

            <div className="w-[30%] max-w-[350px] lg:w-[350px] lg:h-[370px] h-[200px] flex-shrink-0">
              <Image src="/images/teams/6.png" alt="Hands" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>
          </div>
          ...
          <div className="flex flex-wrap lg:gap-4 gap-1 justify-center">
            <div className="w-[30%] max-w-[350px] lg:w-[350px] flex-shrink-0">
              <Image src="/images/teams/7.png" alt="Woman" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>

            <div className="w-[30%] max-w-[350px] lg:w-[350px] flex-shrink-0">
              <Image src="/images/teams/8.png" alt="Man" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>

            <div className="w-[30%] max-w-[562px] lg:w-[562px] flex-shrink-0">
              <Image src="/images/teams/9.png" alt="Hands" width={250} height={250}
                className="lg:rounded-[30px] rounded-[10px] object-cover w-full h-full" />
            </div>
          </div>
        </div>
