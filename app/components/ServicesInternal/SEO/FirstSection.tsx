...
<section className="w-full container  py-0 sm:py-15 lg:py-20 lg:mt-20 -mt-10 flex flex-col md:flex-row items-center justify-between gap-10">
  ...
  <div className="flex-1 text-center md:text-left space-y-4">
    <h1 className= "w-full max-w-[700px] mx-auto md:mx-0 lg:mt-10">
      From crawlability to credibility ,<span className="text-highlight"> we cover it all. </span>
    ...
    <p className="body2 w-full max-w-[600px] mt-4 break-words">
      Search isn’t about being everywhere ,it’s about being in the right place at the right time. We make sure every query leads customers straight to you.
    </p>
