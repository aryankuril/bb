...
const textBlock1 = [
  "Social Media Isn’t Just Posts, It’s Presence.",
  "If you’re not on their feed, you’re not in their world.",
  "From Awareness To Action.",
  "If you’re not on their feed, you’re not in their world.",
  "We make your brand not just seen, but remembered, worth following.",
  "",
];
