...
<section className="w-full container -lg:mt-10 -mt-10 py-0 sm:py-15 lg:py-40 flex flex-col md:flex-row items-center justify-between gap-10">
  {/* Left Side - Text */}
  <div className="flex-1 text-center md:text-left space-y-4">
    <h1 className= "w-full max-w-[700px] mx-auto md:mx-0 lg:mt-10">
    From Viral Moments. We Turn<span className="text-highlight"> Attention </span> Into <span className="text-highlight"> Obsession. </span>
    </h1>

    <p className="body2 w-full max-w-[600px] mt-4 break-words">
     We craft strategies that cut through the noise, build real community, and turn your audience into loyal customers.
