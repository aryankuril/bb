...
const textBlock1 = [
  "Performance Marketing makes brands perform.",
  "Fast, scalable, and fully transparent.",
  "And Customers Connect Instantly",
  "It’s fast, scalable, and completely transparent.",
  "Turning every rupee into growth",
  "",
];
