...
const text =
  "Performance marketing drives brands to perform with speed, scale, and transparency. It connects customers instantly and turns every rupee into measurable growth through smart, data-driven strategies that deliver lasting impact.";
