      ...
      <div>
        <Reveal className="max-w-4xl">
          ...
          <p className="text-muted-foreground mt-4 subtitle">
            Three accounts, three different problems, one method. Scroll
            through the numbers.
          </p>
        </Reveal>
        ...
        <div className="mt-14">
          {cases.map((c, i) => (
            ...
            >
             <article className="card-soft overflow-hidden shadow-lift lg:h-[560px]">
  <div className="grid lg:grid-cols-2">
    <div className="p-7 sm:p-10">
      ...
      <dl className="border-border mt-8 grid grid-cols-3 gap-4 border-t pt-6">
        {c.metrics.map((m) => (
          <div key={m.l}>
            <dt className="text-muted-foreground mt-1 subtitle">
              {m.l}
            </dt>
    ...
    <div className="relative flex h-[300px] items-center justify-center bg-muted p-4 sm:h-[380px] sm:p-6 lg:h-[560px]">
      <Image
        src={c.image}
        alt={c.alt}
        fill
