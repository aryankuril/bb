...
const Firstsection: React.FC = () => {
  ...
  return (
    <section
      ...
      className="relative h-3xl border-b-2 border-[var(--color-highlight)] container py-0 sm:py-15 lg:py-20 lg:mt-10 overflow-hidden px-4 sm:px-6 lg:px-8"
    >
      <div className="flex flex-col lg:flex-row items-end relative lg:mb-0 mb-40">
        <div className="flex-1">
         ...
         Quickly Estimate Your <span className="text-highlight">
              Project Cost
            </span> with <span className="text-highlight">
              Clear Results
            </span>
          </h1>
        </div>
