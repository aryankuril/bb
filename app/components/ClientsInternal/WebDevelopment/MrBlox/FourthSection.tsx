...
//     image: "/images/webdev/mrblox5.jpg",
//   },
//   {

//     image: "/images/webdev/mrblox3.jpg",
//   },
//   {
    
//     image: "/images/webdev/mrblox6.jpg",
//   },
// ];
...
// We created a playful digital space for Mr Blox that captures its Panda mascot&apos;s spirit of curiosity and fun, while making it easy for parents to discover toys that boost kids&apos; cognitive skills.
//         </h3>
//       </div>
  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 relative w-full">
        ...
        >
          ...
          <span style={{ color: spanColor }}>Interaction</span> Into{" "}
          <span style={{ color: spanColor }}>Measurable Results</span> */}
  We created a playful digital space for Mr Blox that captures its Panda mascot’s spirit of curiosity and fun, while making it easy for parents to discover toys that boost kids’ cognitive skills.        </h3>
      </div>
  </section>
  )
}
