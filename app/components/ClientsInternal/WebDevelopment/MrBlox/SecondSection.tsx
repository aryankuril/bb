...
const achievements = [
  {
    number: "01",
    title: "Strategic Wireframing",
    description:
      "Mapped out a clean, parent-friendly structure that simplifies browsing, highlights toy benefits clearly, and keeps the Panda mascot visible throughout the journey for brand consistency.",
    position: "left",
  },
  {
    number: "02",
    title: "Mascot-Led UI/UX",
    description:
      "Designed the entire experience around the Panda mascot — using it across key sections and UI elements to build instant recognition, strengthen brand recall, and maintain a playful identity.",
    position: "right",
  },
  {
    number: "03",
    title: "Kid-Friendly, Parent-Focused Design",
    description:
      "Used soft shapes, bright visuals, and intuitive layouts to create a friendly digital space that parents can easily explore while shopping confidently for 3+ age toys.",
    position: "left",
  },
  {
    number: "04",
    title: "Clean & Modern Shopify Build",
    description:
      "Developed the site on Shopify with a clutter-free layout, smooth navigation, and fast load times — ensuring both performance and a consistent, recognizable Panda-themed brand experience.",
    position: "right",
  },
];
