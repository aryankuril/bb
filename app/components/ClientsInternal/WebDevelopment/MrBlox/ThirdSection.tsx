...
const timelineData = [
  {
    week: "(Week 1–2): Discovery & UX Strategy",
    desc: "Mapped the customer journey and wireframed core features, focusing on a frictionless UX strategy tailored for the suit customization process.",
    img: "/images/timeline1.png",
  },
  {
    week: "(Week 3–4): UI Design & Prototyping",
    desc: "Developed a sophisticated visual identity and high-fidelity prototypes to validate and refine the platform’s user-centric design approach.",
    img: "/images/timeline2.png",
  },
  {
    week: "(Week 5–8): Development, Testing & Launch",
    desc: "Built the full-stack e-commerce platform—from pixel-perfect front-end to back-end logic for managing custom orders—followed by rigorous QA testing, secure payment integration, and final deployment.",
  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 min-h-[100vh]">
      <h1 className="text-[#000] font-[Miso] text-3xl sm:text-5xl md:text-6xl lg:text-[80px] font-normal leading-snug tracking-tight capitalize text-center mb-10 px-4">
        Timeline for <span className="text-[#FAB31E]">My Suit Tailor</span>
      </h1>
