...
const timelineData = [
  {
    week: "(Week 1–2): Discovery & Design",
    desc: "Established the project foundation by setting up the core Shopify infrastructure and selecting a premium, mobile-first theme that aligned with the SuperSox brand’s aesthetic and functional goals.",
    img: "/images/timeline1.png",
  },
  {
    week: "(Week 3–4): WordPress Development",
    desc: "Developed a custom, fully responsive WordPress theme with a streamlined backend, enabling the foundation’s team to easily manage and update website content.",
    img: "/images/timeline2.png",
  },
  {
    week: "(Week 5–6): Content, Testing & Launch",
    desc: "Populated the site with finalized content, integrated donation and volunteer signup features, conducted thorough cross-device testing, and successfully launched the new website.",
