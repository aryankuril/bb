...
// Our strategy was to make bespoke tailoring accessible. We transformed a complex process into an enjoyable and interactive digital journey, creating a platform that guides users like a personal style consultant.
//         </h3>
//       </div>
...
//       src={card.image}
//       alt=""
//       className="absolute top-0 left-0 w-full h-full object-contain rounded-[20px] -z-10 overflow-hidden"
//       style={{
  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 relative w-full">
        ...
        >
          ...
          <span style={{ color: spanColor }}>Interaction</span> Into{" "}
          <span style={{ color: spanColor }}>Measurable Results</span> */}
Our strategy was to make bespoke tailoring accessible. We transformed a complex process into an enjoyable and interactive digital journey, creating a platform that guides users like a personal style consultant.        </h3>
      </div>
  </section>
  )
}
