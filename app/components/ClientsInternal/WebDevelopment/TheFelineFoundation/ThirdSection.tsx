...
const timelineData = [
  {
    ...
    desc: "Configured the Shopify store and selected a premium theme designed to handle a large-scale inventory, setting the foundation for a smooth shopping experience.",
  ...
  {
    week: "(Week 4): Final Testing & Launch",
    desc: "Conducted thorough end-to-end user journey testing to ensure a seamless experience, followed by the successful launch of the online store.",
  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 min-h-[100vh]">
      <h1 className="text-[#000] font-[Miso] text-3xl sm:text-5xl md:text-6xl lg:text-[80px] font-normal leading-snug tracking-tight capitalize text-center mb-10 px-4">
        Timeline for <span className="text-[#FAB31E]">Feline Foundation</span>
      </h1>
