...
const achievements = [
  {
    ...
    title: "Building UX",
    description:
      "Built a seamless UX that mirrors the brand’s flow and ease.",
    position: "left",
  },
  {
    number: "02",
    ...
    description:
      "Crafted a neutral, tactile colour palette inspired by Blancora’s fabrics.",
    position: "right",
  },
  {
    number: "03",
    title: "Aesthetics",
    description:
      "Designed intuitive storytelling visuals that evoke comfort and quiet confidence.",
    position: "left",
  },
  {
    number: "04",
    ...
    description:
      "Balanced editorial finesse with everyday accessibility to make luxury feel lived-in.",
    position: "right",
  },
];
