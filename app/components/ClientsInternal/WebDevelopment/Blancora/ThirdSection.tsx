...
const timelineData = [
  {
    week: "(Week 1–3): Research & Design Strategy",
    desc: "Conducted in-depth research to define user personas and information architecture, followed by the creation of foundational wireframes and high-fidelity UI mockups that established the project's visual and structural direction.",
    img: "/images/timeline1.png",
  },
  {
    week: "(Week 4–6): Development & Integration",
    desc: "Converted approved designs into a fully responsive front-end, built the back-end architecture, integrated the CMS, and ensured seamless performance across all devices and platforms.",
    img: "/images/timeline2.png",
  },
  {
    week: "(Week 7–8): Testing, Optimization & Launch",
    desc: "Performed comprehensive QA testing, refined the website based on feedback, integrated all final content, and deployed the project live — marking the successful completion of the build.",
  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 min-h-[100vh]">
      <h1 className="text-[#000] font-[Miso] text-3xl sm:text-5xl md:text-6xl lg:text-[80px] font-normal leading-snug tracking-tight capitalize text-center mb-10 px-4">
        Timeline for <span className="text-[#FAB31E]">J K Diamonds Institute</span>
      </h1>
        ...
        <div className="p-8 sm:p-10 space-y-6 relative z-10">
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                <h3 className="lg:w-[900px] w-full text-[#FFF] font-[Miso] text-xl sm:text-2xl md:text-3xl lg:text-[40px] font-bold leading-snug tracking-tight">
