...
const achievements = [
  {
    ...
    title: "Awareness Up",
    description:
      "Consistent, clear financial content boosted reach and profile visits.",
    position: "left",
  },
  {
    number: "02",
    title: "DVC Impact",
    description:
      "Our new brand film didn’t just launch online — it played in theatres across the city, cutting through festive noise and boosting brand recall.",
    position: "right",
  },
  {
    number: "03",
    title: "Festive Presence",
    description:
      "Strong Diwali & Navratri communication kept Manba visible across channels, growing the community to 10K+ Instagram followers.",
    position: "left",
  },
  {
    number: "04",
    title: "Real Results",
    description:
      "Higher visibility + festive demand led to a strong rise in loan disbursals, supported by 1M+ YouTube views on our campaigns.",
    position: "right",
  },
];
