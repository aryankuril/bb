...
const achievements = [
  {
    ...
    description:
      "Defined his voice around aviation expertise, nostalgia, and real storytelling — warm, witty, and authentic.",
    position: "left",
  },
  {
    number: "02",
    ...
    description:
      "Built content pillars around aviation insights, industry stories, Damania Airways nostalgia, and art & culture.",
    position: "right",
  },
  {
    number: "03",
    title: "High-Impact Reels",
    description:
      "Created reels that consistently crossed 100k+ views, using emotional storytelling and insider perspective.",
    position: "left",
  },
  {
    number: "04",
    ...
    description:
      "Engaged with ex-aviators, young pilots, and aviation enthusiasts to spark conversations and build trust.",
    position: "right",
  },
];
