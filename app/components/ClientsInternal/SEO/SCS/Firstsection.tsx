...
const Firstsection = () => {
  ...
  return (
    <section className=" container py-0 sm:py-15 lg:py-20 lg:mt-10 ">
      {/* Headline */}
      <div className="mb-8 md:mb-12">
        <h1 className="max-w-full black-text">
From Clicks to Cash: Driving Massive <span className="text-highlight">
           SEO Revenue
            </span> for SCS Sports
...
Despite being a retail giant, SCS Sports' online presence wasn't reaching its full potential. Their website structure was too shallow to capture the wide array of specific customer searches—from professional equipment to sports-specific tips—causing them to miss out on significant organic traffic and revenue.
        </p>
      </div>
    </section>
  );
