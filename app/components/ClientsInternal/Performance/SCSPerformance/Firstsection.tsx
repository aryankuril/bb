  ...
  return (
    <section className=" container py-0 sm:py-15 lg:py-20 lg:mt-10 ">
      ...
      <div className="mb-8 md:mb-12">
        ...
        Game, Set, Match: <span className="text-highlight">
            12x ROAS
            </span> Success Story for SCS Sports
...
SCS Sports, a legacy sports equipment distributor, was just stepping into e-commerce. They had no online sales and zero presence on performance channels, facing the challenge of translating 37 years of offline success into digital revenue.
        </p>
      </div>
    </section>
  );
