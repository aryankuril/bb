  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 relative w-full">
        ...
        >
          ...
          <span style={{ color: spanColor }}>Interaction</span> Into{" "}
          <span style={{ color: spanColor }}>Measurable Results</span> */}
Through clear positioning and vibrant design, “Making India Play” evolved into a nationwide movement that inspires young athletes, builds community, and strengthens India’s sporting ecosystem for generations to come.        </h3>
      </div>
  </section>
  )
}
