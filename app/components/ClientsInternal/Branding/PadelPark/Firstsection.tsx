...
Building India’s Next Sport Movement: <span className="text-highlight">
...
Padel Park set out to build a bold, modern identity that captures their mission of expanding padel culture and making the sport accessible across India.        </p>
      </div>
    </section>
  );
};
