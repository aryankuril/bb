  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 relative w-full">
        ...
        >
          ...
          <span style={{ color: spanColor }}>Interaction</span> Into{" "}
          <span style={{ color: spanColor }}>Measurable Results</span> */}
With strategic clarity and energetic design, we helped Padel Park strengthen its identity as a community-first sports destination.
 Padel Park stands positioned to lead the movement, shape culture, and accelerate the growth of padel across India.    </h3>
      </div>
  </section>
  )
}
