  ...
  return (
    <section className="container py-10 sm:py-15 lg:py-20 relative w-full">
        ...
        >
          ...
          <span style={{ color: spanColor }}>Interaction</span> Into{" "}
          <span style={{ color: spanColor }}>Measurable Results</span> */}
With elevated storytelling and a clear ethical-luxury voice, Bombay Artisan Co now stands as a modern benchmark of craftsmanship—uniting legacy, sustainability, and timeless sophistication across every product category.
    </h3>
      </div>
  </section>
  )
