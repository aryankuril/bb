...
BOMBAY ARTISAN CO, Ethical Luxury Reimagined elevating their  <span className="text-highlight">
       digital presence
            </span> 
...
Bombay Artisan Co aimed to elevate their presence in the ethical luxury space while honouring their 1913 Gold Filled legacy.        </p>
      </div>
    </section>
  );
};
