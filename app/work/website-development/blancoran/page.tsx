...
export const metadata: Metadata = {
  title: "Case Study for Blancoran",
  description: "Discover how Bombay Blokes enhanced Blancoran search engine performance through keyword optimization, content strategy & link building for measurable ROI.",
};
